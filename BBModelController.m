...
-(BBIssue*)getIssueForIssueCategory:(BBIssueCategory*)_category
   ...
   return [FMDBDataAccess getIssueForCategory:_category 
							byType:[NSNumber numberWithInt:issueType]];
}

- (NSMutableArray*)getIssuesForCategory:(BBIssueCategory*)category 
														byType:(int)type {
    return [FMDBDataAccess getIssuesForCategory:category 
														byType:[NSNumber numberWithInt:type]];
}
